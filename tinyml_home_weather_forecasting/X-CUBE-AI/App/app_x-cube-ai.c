...
AI_ALIGNED(32)
static uint8_t pool0[AI_FORECAST_TEMP_ML_MODEL_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_FORECAST_TEMP_ML_MODEL_MODEL_NAME,
        .config = AI_FORECAST_TEMP_ML_MODEL_DATA_CONFIG,
        .ai_get_report = ai_forecast_temp_ml_model_get_report,
        .ai_create = ai_forecast_temp_ml_model_create,
        .ai_destroy = ai_forecast_temp_ml_model_destroy,
        .ai_get_error = ai_forecast_temp_ml_model_get_error,
        .ai_init = ai_forecast_temp_ml_model_init,
        .ai_run = ai_forecast_temp_ml_model_run,
        .ai_forward = ai_forecast_temp_ml_model_forward,
        .ai_data_params_get = ai_forecast_temp_ml_model_data_params_get,
